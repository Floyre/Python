...
form_class = uic.loadUiType(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\Main_Menu.ui")[0]
...
class AddWindow(QDialog):
    def __init__(self, parent):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\Add_Window.ui", self)
        self.show()
...
class ViewWindow(QDialog):
    def __init__(self, parent):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\View_Window.ui", self)
        self.show()
        self.QuitBTN.clicked.connect(self.CloseAddWindow)
        self.appendmaster()
    ...
    def appendmaster(self):
        viewrowcount = 50
        viewcolumncount = 5
        self.TableResult.setRowCount(viewrowcount)
        self.TableResult.setColumnCount(viewcolumncount)
        self.TableResult.setHorizontalHeaderLabels(["물건 이름", "물건 위치", "보관 날짜", "물건 주인", "물건 가격"])

        i = 0
        for data in data_list:
            tabledata = QTableWidgetItem(data.name)
            self.TableResult.setItem(i, 0, tabledata)
            tabledata = QTableWidgetItem(data.locate)
            self.TableResult.setItem(i, 1, tabledata)
            tabledata = QTableWidgetItem(data.date)
            self.TableResult.setItem(i, 2, tabledata)
            tabledata = QTableWidgetItem(data.owner)
            self.TableResult.setItem(i, 3, tabledata)
            tabledata = QTableWidgetItem(data.price)
            self.TableResult.setItem(i, 4, tabledata)
            i = i+1
...
class SearchWindow(QDialog):
    def __init__(self, parent):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\Search_Window.ui", self)
        self.show()
...
class SearchResultWindow(QDialog):
    def __init__(self, parent, InputText):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\Searchres_Window.ui", self)
        self.show()
...
class DeleteWindow(QDialog):
    def __init__(self, parent, deleteWinRef):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\Delete_Window.ui", self)
        self.show()
...
class DeleteResultSuccessWindow(QDialog):
    def __init__(self, parent, DeleteInput):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\Deleteres_Success_Window.ui", self)
        self.show()
...
class DeleteResultFailWindow(QDialog):
    def __init__(self, parent, DeleteInput):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\Deleteres_Fail_Window.ui", self)
        self.show()
        self.DelNumber.setText(DeleteInput)
...
class SaveWindow(QDialog):
    def __init__(self, parent):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\Save_Window.ui", self)
        self.show()
...
class LoadWindow(QDialog):
    def __init__(self, parent):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\Load_Window.ui", self)
        self.show()
...
class CSVWindow(QDialog):
    def __init__(self, parent):
        ...
        uic.loadUi(r"C:\Users\cariano0212\Desktop\Study\Python\Object Management\Ui_folder\CSV_Window.ui", self)
        self.show()
